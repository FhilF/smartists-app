_5e9‍.x([["aggregateSmartistsMember",()=>aggregateSmartistsMember]]);const { COLLECTION } = require("radiks-server/app/lib/constants");
const sortBy = require("lodash/sortBy");

       const aggregateSmartistsMember = async (radiksData, query) => {
  const match = {
    $match: {
