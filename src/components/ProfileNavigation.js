  ...
  return (
    <div className="profile-root">
      <div className="card pb-20">
        ...
        <div className="p-20 pt-10 pb-10">
          <div className="profile-information mt-30">
            ...
            <h1 className="profile-username">@fenrir09.id.blockstack</h1>
          </div>
          <div className="mt-10">
            ...
            <div className="mt-10">
              <p className="p-subtext text-gray-800">Date joined</p>
              <p className="p-subtext text-gray-600">
                {isPageLoading ? "" : smartistsUser.description}
              </p>
            </div>
          </div>
      ...
      <div className="card mt-20 p-20">
        <div>
          <p
            className="component-header color-secondary"
          ...
          <div className="mt-10">
            <div className="mt-20">
              <p className="p-text text-gray-600">Skills as an artist</p>
              <ul className="list">
                {isPageLoading
                  ? null
            ...
            <div className="mt-20">
              <p className="p-text text-gray-600">Open for work?</p>
              <p className="p-paragraph text-gray-900">
                {isPageLoading
                  ? null
      ...
      <div className="card mt-20 p-20">
        <div>
          ...
          <div className="mt-10">
            <div className="mt-20">
              <p className="p-text text-gray-600">Major Interest</p>
              <p className="p-paragraph text-gray-800">
                {isPageLoading
                  ? null
